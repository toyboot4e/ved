// Spike driver: can a lone ruby-text leaf annotate its plain siblings
// without a wrapper element? Run from the repo root (after a build):
// node docs/spikes/identity-anon.spike.ts
