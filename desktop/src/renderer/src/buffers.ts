...
// A pure reducer over plaintext + scalars; the live editor state (ProseMirror
// doc, hot-path text) stays in the editor. PlainTextHistory is a live instance
// held here so undo survives tab switches, but it is never serialized.
import { type CursorState, PlainTextHistory } from '@ved/editor';
